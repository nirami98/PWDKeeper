...
public class DatabaseConnectivity {
    ...
    public static void addData() throws Exception {
        ...
        if (!validateWebsite()) {
            ...
            if (!validateEmail(email)) {
                ...
                ResultSet rs = statementObj
                        .executeQuery("select * from data where email='" + email + "' and website='" + website + "'");
                if (!rs.next()) {
                    String query = String.format(
                            "insert into data (website, email, password, pwdkey) values ('%s', '%s', '%s', '%s')",
                            website, email, encrypted_pwd, pwdkey);
    ...
    public static void getEmail_View() throws Exception {
        ...
        Statement statementObj = DatabaseUtil.getConnection().createStatement();
        ResultSet rs = statementObj
                .executeQuery("select DISTINCT email from data where website='" + website_data + "'");
    ...
    public static void updateData() throws Exception {
        ...
        if (UpdateData_Panel.check_password.isSelected())
            ...
            ResultSet rs = statementObj
                    .executeQuery("select * from data where website='" + website + "' and email='" + email + "'");
            while (rs.next())
        ...
        if (!validateEmail(email)) {
            ...
            statementObj.executeUpdate("update data set email='" + email + "' where website='" + website
                    + "' and email='" + email_data + "'");

            String password_data[] = encryptpwd(password);
            String encrypted_pwd = password_data[0];
            String pwdkey = password_data[1];

            int isSuccess = statementObj.executeUpdate("update data set password='" + encrypted_pwd + "', pwdkey='"
                    + pwdkey + "' where website='" + website + "' and email='" + email + "'");
    ...
    public static void deleteData() throws Exception {
        ...
        int isSuccess = statementObj
                .executeUpdate("delete from data where website ='" + website + "' and email = '" + email + "' ");
